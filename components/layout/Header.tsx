        ...
        <div className="flex items-center justify-between h-20">
          ...
          <div className="flex items-center space-x-3">
            ...
            {authenticated && user ? (
              ...
              <Link
                href="/login"
                className="group flex items-center space-x-2 px-5 py-2.5 rounded-xl bg-gradient-to-r from-[#69E6A6] to-[#5dd195] hover:from-[#5dd195] hover:to-[#4fb882] text-[#0A2640] font-semibold text-sm transition-all duration-300 hover:scale-105 shadow-lg shadow-[#69E6A6]/30 hover:shadow-[#69E6A6]/50"
              >
                <svg className="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
