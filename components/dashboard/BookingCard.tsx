...
export function BookingCard({
      ...
      <div className="pt-6">
        ...
        <div className="flex items-start justify-between mb-4">
          <div className="flex-1 min-w-0 pr-3">
            {booking.service && (
              <>
                <h3 className="text-white font-bold text-base mb-1.5 truncate group-hover:text-[#69E6A6] transition-colors">
                  {booking.service.name}
                </h3>
                {booking.service.basePrice && (
                  <p className="text-[#69E6A6] font-bold text-sm">
          ...
          <div className="flex flex-col items-end gap-1.5 flex-shrink-0">
            <span className={`px-3 py-1 rounded-lg text-xs font-bold ${status.bg} ${status.text} ${status.border} border flex items-center gap-1.5 shadow-md`}>
        ...
        <div className="space-y-3 mb-4">
          ...
          <div className="flex items-center gap-4">
            <div className="flex items-center gap-2 flex-1">
              ...
              <div>
                <p className="text-white/60 text-[10px] mb-0.5">Date</p>
            ...
            <div className="flex items-center gap-2 flex-1">
              ...
              <div>
                ...
                <p className="text-white font-semibold text-xs">{booking.timeSlot}</p>
              </div>
            </div>
          </div>
          ...
          <div className="flex items-center gap-2">
            <div className="w-8 h-8 rounded-lg bg-[#69E6A6]/10 flex items-center justify-center flex-shrink-0">
            ...
            <div className="flex-1 min-w-0">
              <p className="text-white/60 text-[10px] mb-0.5">Location</p>
              <p className="text-white font-semibold text-xs truncate">{booking.area}, Kathmandu</p>
            </div>
          </div>
        </div>
  ...
  const baseClasses = `relative rounded-2xl bg-gradient-to-br from-[#1C3D5B] via-[#0F2A47] to-[#0A2640] border border-white/10 p-5 hover:border-[#69E6A6]/40 hover:shadow-2xl hover:shadow-[#69E6A6]/15 transition-all duration-300 hover:-translate-y-0.5 ${className}`;
